...
void GetHistograma(int histograma[])
{
...
void DrawHistograma(int histograma[]){
    ...
    int xOffSet = Image.SizeX() / 255;
    int yOffSet = 2 + maxY / Image.SizeY();

    cout << "x off set " << xOffSet << endl;
    cout << "y off set " << yOffSet << endl;
